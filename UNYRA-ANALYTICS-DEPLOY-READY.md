# Unyra Analytics Deploy Ready

Este checkpoint representa a base oficial com:

- website oficial desktop/mobile
- integracao do `@vercel/analytics`
- layout raiz instrumentado com `<Analytics />`
...
Para voltar exatamente a esta base salva:
